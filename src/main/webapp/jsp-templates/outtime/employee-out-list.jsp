...
<html>
 ...
 <div class='dvv'>
     <label class='hdu'>Out list of current date</label>
  </div>
  <div class='container'>
   <div class='card col-md-12 mx-auto'>
    <div class='card-body'>
     <c:if test="${elist=='[]'}">
       <div class='dv'>
        <label class='lahu' style='color:red'>No employee is out yet now</label>
       </div>
     </c:if>
     <c:if test="${elist!='[]'}">
     ...
     <table class='table table-hover'>
      ...
      <tbody>
        ...
        <tr>
    	   ...
    	   <td style='color:red' class='las'>${emp.intime}</td>
    	   <td style='color:red' class='las'>${emp.totaltime}</td>
    	   <td class='las'>${emp.date}</td>
    	   <td class='las'>
    	    <a href='edit-list?eid=${emp.eid}'>Edit</a>
    	   </td>
    	</tr>
    	</c:forEach>
      </tbody>
